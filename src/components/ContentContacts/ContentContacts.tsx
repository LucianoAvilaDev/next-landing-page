...
const ContentContacts = ({ id }: Props) => {
    return (
        <div id={id}>
            <div className="flex flex-col items-center justify-center w-full min-h-[25vw] bg-black/90">
                <div className="flex flex-col sm:flex-row justify-between border-gray-100 lg:w-2/4 sm:w-3/4 align-center py-6">
                    <div className="flex flex-col px-4 ">
                        ...
                        <div className="sm:text-start text-justify pt-4 text-md text-white/80">
                            Landing Page - um projeto de estudo em React +
                            Nextjs
                        </div>
                        <div className="sm:text-start text-justify text-md text-white/80">
                            Desenvolvido por{' '}
                ...
                <div className="text-xl pt-4 sm:pt-8  text-white/80">
